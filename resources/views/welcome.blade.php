...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{ url('/login_example') }}" class="text-sm text-gray-700 underline">Log in</a>


            <a href="{{ url('/register_example') }}" class="ml-4 text-sm text-gray-700 underline">Register</a>
